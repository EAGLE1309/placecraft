    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-zinc-900 dark:to-zinc-800 p-4">
      <Card className="w-full max-w-md shadow-xl">
        <CardHeader className="text-center">
          <div className="mx-auto mb-4 h-20 w-20 rounded-full bg-gradient-to-br from-blue-500 to-indigo-600 flex items-center justify-center shadow-lg">
        ...
        <CardContent className="space-y-4">
          ...
          <div className="pt-4 border-t">
            <p className="text-xs text-center text-muted-foreground">
              Sign in as a <span className="font-medium">Student</span>, <span className="font-medium">Recruiter</span>, or <span className="font-medium">Placement Cell</span>
            </p>
          </div>
        </CardContent>
      </Card>
